...
public class Main {
    public static void main(String[] args) {
        ...
        // Menampilkan Total Take Home Pay Masing-masing Pegawai
        System.out.println("\nTake Home Pay Pegawai 1 (" + pegawai1.jabatan + "): $" + takeHomePay1);
        System.out.println("Take Home Pay Pegawai 2 (" + pegawai2.jabatan + "): $" + takeHomePay2);
        System.out.println("Take Home Pay Pegawai Paruh Waktu (" + pegawaiPW.jabatan + "): $" + takeHomePayPW);
